...
class MythicMusic(discord.Client):
    def __init__(self, config_file=None, perms_file=None):
        ...
        log.info('Starting Mythic Music v1.0')
        ...
        self.http.user_agent += ' Mythic Music'
...
#######################################################################################################################
    ...
    def _gen_embed(self):
        ...
        e = discord.Embed()
        e.colour = 7506394
        e.set_footer(text='BlulightningGhost/Mythic Music', icon_url='https://i.imgur.com/gFHBoZA.png')
    ...
    async def on_server_join(self, server:discord.Server):
        ...
        if not self.user.bot:
            alertmsg = "<@{uid}> Hi I'm a music bot please mute me."
